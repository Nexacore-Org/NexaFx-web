...
export default function VerifyOtpPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-[#A0C3FD] to-[#FFE79C]">
      ...
      {/* Desktop View */}
      <div className="hidden md:flex items-center justify-center px-4" style={{ minHeight: 'calc(100vh - 88px)' }}>
        <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-12">
          <div className="mb-8">
            <h1 className="text-3xl font-semibold mb-4 text-center">VERIFY CODE</h1>
      ...
      <div className="md:hidden min-h-screen bg-linear-to-br from-[#A0C3FD] to-[#FFE79C] p-4">
        ...
        <div className="flex items-center justify-center" style={{ minHeight: 'calc(100vh - 120px)' }}>
          <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
            <div className="mb-8">
              <h1 className="text-2xl font-semibold text-center mb-4">VERIFY CODE</h1>
