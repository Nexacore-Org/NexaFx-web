...
export default function ProfileTab() {
  ...
  return (
    <div className="space-y-6">
      {/* Profile Header */}
      <div className="flex items-center justify-between h-[176px] rounded-xl bg-gradient-to-r from-[#FFA200] to-[#3B82F6] p-6 text-white shadow-md">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold">{data?.username || "User"}</h2>
        ...
        <span
          className={`px-4 py-1 rounded-full text-sm font-medium ${
            data?.idVerified ? "bg-green-600" : "bg-red-500"
          }`}
        >
      ...
      <div className="p-4 rounded-lg border bg-white shadow-sm">
        ...
        <p className="text-gray-600">{data?.email || "a***@yahoo.com"}</p>
      </div>
      ...
      <div className="p-6 rounded-lg border bg-white shadow-sm">
        ...
        <div className="flex items-center justify-between">
          <div className="max-w-md">
            <h3 className="text-lg font-medium text-gray-900 ">Fiat Display</h3>
          ...
          <div className="flex gap-2 items-center">
                ...
                <div
                  className={`w-6 h-6 border-2 rounded flex items-center justify-center transition-all ${
                    selectedFiats.includes("NGN")
                      ? "border-transparent bg-gradient-to-r from-[#FFA200] to-[#3B82F6]"
            ...
            <label className="flex gap-2 text-sm items-center flex-row-reverse justify-between rounded-lg hover:border-gray-300 transition-colors cursor-pointer">
              <span className="font-medium text-gray-900">USDT/USDC</span>
              <div className="relative">
                <input
                  type="checkbox"
      ...
      {/* Actions */}
      <div className="flex justify-end gap-4 pt-4">
        <button className="border border-gray-300 px-6 py-2 rounded-lg hover:bg-gray-50 transition-colors text-gray-700 font-medium">
          Cancel
        </button>
        <button
          onClick={handleSave}
