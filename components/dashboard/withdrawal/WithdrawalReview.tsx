...
const currencies = [
  ...
  },
  {
    id: "ETH",
    name: "Ethereum",
    icon: <BadgeDollarSign className="w-8 h-8 text-neutral-500" />,
  },
  {
    id: "BNB",
    name: "BNB",
    ...
    <div className="p-6 space-y-6 relative">
      ...
      <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-3">
        <p className="text-xs text-yellow-600 dark:text-yellow-400">
          <span className="font-semibold">Important:</span> Please verify the
          wallet address is correct. Transactions cannot be reversed once
          confirmed.
        </p>
      </div>
