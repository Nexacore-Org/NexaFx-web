              ...
              <div className="bg-white lg:rounded-lg lg:border lg:border-gray-200 lg:p-5">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <p className="text-sm text-gray-900 font-medium">
                      {showSensitiveInfo ? currentUser.email : 'ΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇó'}
                    </p>
                  </div>
                  <div className="flex justify-between items-center">
                    <p className="text-sm text-gray-500">Phone Number</p>
                    <p className="text-sm text-gray-900 font-medium">
                      {showSensitiveInfo ? currentUser.phone || 'No phone number' : 'ΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇó'}
                    </p>
                  </div>
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2">
                      <p className="text-sm text-gray-900 font-medium">
                        {showSensitiveInfo ? currentUser.walletAddress || 'No wallet address' : 'ΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇó'}
                      </p>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <p className="text-sm text-gray-900 font-medium">
                      {showSensitiveInfo ? currentUser.username : 'ΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇó'}
                    </p>
                  </div>
                </div>
